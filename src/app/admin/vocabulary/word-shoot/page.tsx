...
import { ArrowLeft, Target, Trophy, BookOpen, Zap, Heart } from 'lucide-react'
import Link from 'next/link'
import VocabularyWordShootGame from '@/components/vocabulary/games/VocabularyWordShootGame'

export default function VocabularyWordShootPage() {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Shoot floating vocabulary bubbles to match physics terms with definitions
          </p>
        </div>
      </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={difficulty} onValueChange={(value: 'easy' | 'medium' | 'hard') => setDifficulty(value)}>
                      ...
                      <SelectContent>
                        <SelectItem value="easy">Easy (Slow bubbles, 5 lives)</SelectItem>
                        <SelectItem value="medium">Medium (Normal speed, 3 lives)</SelectItem>
                        <SelectItem value="hard">Hard (Fast bubbles, 2 lives)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Learn the rules of Physics Word Shoot
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        A physics definition appears at the top of the screen
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">Shoot the bubbles</h4>
                      <p className="text-sm text-muted-foreground">
                        Click on floating bubbles to &quot;shoot&quot; them
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">Hit the correct term</h4>
                      <p className="text-sm text-muted-foreground">
                        Green bubbles are correct, red bubbles cost lives
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="mt-3 text-center">
                    <div className="text-sm text-muted-foreground">
                      + Streak bonus (3+ correct) • Wrong bubbles cost lives
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {gameLength} questions • {difficulty} difficulty
                </p>
              </div>
            </div>
          </div>
