...
export const projectileDef: SimDefinition = {
  ...
  sensors: [
    { key: 'vy', kind: 'motion', label: 'Motion Detector', quantity: 'Vertical velocity', unit: 'm/s' },
    { key: 'vx', kind: 'motion', label: 'Motion Detector', quantity: 'Horizontal velocity', unit: 'm/s' },
