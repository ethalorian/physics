...
# Tiered SEI vocabulary per week (Beck tiers: 3 = the physics word, 2 = the academic word the
# frames need, 1 = the everyday word first). The Spanish field carries the cognate (≈) or the
# translation; false friends are flagged (≠). One vocabulary_set per lesson, shown by a
# lesson_vocab block and available to the arcade games.
# (tier, term, part_of_speech, definition, spanish, example)
VOCAB = {'pp-w00': [(1, 'push', 'verb', 'Move something away from you.', 'empujar', 'Push the cart.'), (1, 'pull', 'verb', 'Move something toward you.', 'jalar / tirar', 'Pull the string.'), (2, 'predict', 'verb', 'Say what will happen before it happens.', 'predecir ≈', 'I predict the tower will be 40 cm tall.'), (2, 'measure', 'verb', 'Find a number with a tool.', 'medir', 'Measure the height with the meter stick.'), (2, 'evidence', 'noun', 'The numbers or drawings that show something is true.', 'evidencia ≈', 'My evidence is the measurement: 32 cm.'), (3, 'prediction', 'noun', 'What you say will happen, written before the test.', 'predicción ≈', 'Lock your prediction before you build.'), (3, 'timeline', 'noun', 'The record of what you planned and what really happened.', 'línea de tiempo', 'Write the build time on your timeline.')], 'pp-w01': [(1, 'faster', 'adjective', 'More speed.', 'más rápido', 'The cart is faster at the bottom.'), (1, 'slower', 'adjective', 'Less speed.', 'más lento', 'Walk slower to make the line flatter.'), (2, 'graph', 'noun', 'A picture of numbers: one thing across, one thing up.', 'gráfica ≈', 'Read the graph before the screen shows it.'), (2, 'slope', 'noun', 'How steep a line is on a graph.', 'pendiente', 'A steeper slope means a bigger velocity.'), (3, 'position', 'noun', 'Where something is, measured from a starting point.', 'posición ≈', 'Position is on the up-axis of the first graph.'), (3, 'velocity', 'noun', 'How fast, and in which direction.', 'velocidad ≈', 'The slope of a position–time graph is velocity.'), (3, 'acceleration', 'noun', 'How fast the velocity changes.', 'aceleración ≈', 'A curving position graph means acceleration.'), (3, 'displacement', 'noun', 'The change in position: where you ended minus where you started.', 'desplazamiento', 'The area under a velocity graph is displacement.')], 'pp-w02': [(1, 'ramp', 'noun', 'A sloped surface.', 'rampa ≈', 'Put the cart at the top of the ramp.'), (1, 'steep', 'adjective', 'A big angle; hard to climb.', 'empinado / inclinado', 'The steep ramp gives more acceleration.'), (2, 'angle', 'noun', 'How much a line is turned from flat, in degrees.', 'ángulo ≈', 'Measure the angle of the ramp.'), (2, 'data', 'noun', 'The numbers you collected.', 'datos ≈', 'Use your own data to predict.'), (3, 'gravity', 'noun', 'The pull of Earth on everything.', 'gravedad ≈', 'The ramp dilutes gravity.'), (3, 'g', 'symbol', 'The acceleration of gravity near Earth: about 9.8 m/s² straight down.', 'g (aceleración de la gravedad)', 'A vertical ramp would read g.'), (3, 'friction', 'noun', 'The force that fights sliding.', 'fricción ≈', 'Friction explains the gap.'), (3, 'run-out', 'noun', 'How far the cart rolls on the floor after the ramp.', 'recorrido (≠ carrera)', 'Predict the run-out at the new angle.')], 'pp-w03': [(1, 'string', 'noun', 'A thin line the car rides on.', 'cuerda / hilo', 'The car slides along the string.'), (1, 'balloon', 'noun', 'A rubber bag full of air.', 'globo', 'Air leaves the balloon backward.'), (2, 'claim', 'noun', 'What you say is true, backed by evidence.', 'afirmación', 'My claim: friction on the string limits the run.'), (2, 'compare', 'verb', 'Look at two things to see what is different.', 'comparar ≈', 'Compare a heavy passenger and a light one.'), (3, 'force', 'noun', 'A push or a pull.', 'fuerza ≈', 'Draw every force on the car.'), (3, 'thrust', 'noun', 'The forward push from air (or fuel) leaving backward.', 'empuje', 'Thrust points forward while air leaves backward.'), (3, 'net force', 'noun', 'All the forces added together, with direction.', 'fuerza neta ≈', 'When thrust wins, the net force points forward.'), (3, 'free-body diagram', 'noun', 'A drawing of one object with an arrow for each force.', 'diagrama de cuerpo libre', 'Label every arrow on the free-body diagram.')], 'pp-w04': [(1, 'launch', 'verb', 'Send something up.', 'lanzar', 'Launch the rocket when the pressure is ready.'), (1, 'height', 'noun', 'How high something goes.', 'altura', 'Measure the height from the hang time.'), (2, 'change', 'verb', 'Make something different on purpose.', 'cambiar', 'Change ONE thing for launch two.'), (2, 'increase', 'verb', 'Make bigger.', 'aumentar', 'Increase the water and predict the apex.'), (3, 'momentum', 'noun', 'Mass times velocity; how hard something is to stop.', 'cantidad de movimiento (≠ momento)', 'Water going down carries momentum; the rocket goes up with the same amount.'), (3, 'impulse', 'noun', 'A force acting for a time; it changes momentum.', 'impulso ≈', 'More impulse means a higher apex.'), (3, 'apex', 'noun', 'The highest point of the flight.', 'punto más alto / ápice ≈', 'Predict the apex before you launch.'), (3, 'projectile', 'noun', 'Anything flying with only gravity pulling on it.', 'proyectil ≈', 'A projectile has two motions: up-down and sideways.')], 'pp-w05': [(1, 'bridge', 'noun', 'A structure that crosses a gap.', 'puente', 'Build the bridge from the template.'), (1, 'break', 'verb', 'Come apart under load.', 'romperse', 'Which piece will break first?'), (2, 'template', 'noun', 'A pattern you cut and build from.', 'plantilla', 'Cut the truss from the template.'), (2, 'label', 'verb', 'Write the name on each part.', 'etiquetar', 'Label every member T or C.'), (3, 'tension', 'noun', 'A member being pulled from both ends.', 'tensión ≈', 'The bottom chord is in tension.'), (3, 'compression', 'noun', 'A member being pushed from both ends.', 'compresión ≈', 'The top chord is in compression.'), (3, 'equilibrium', 'noun', 'All forces balance; nothing moves.', 'equilibrio ≈', 'A bridge that stays still is in equilibrium.'), (3, 'truss', 'noun', 'A structure made of triangles.', 'armadura (de triángulos)', 'A truss holds its shape because of the triangles.')], 'pp-w06': [(1, 'handle', 'noun', 'The part you hold.', 'asa', 'A handle far from the center makes the mug tip.'), (1, 'choose', 'verb', 'Pick one.', 'elegir', 'Choose one design of the three.'), (2, 'constraint', 'noun', 'A rule the design must follow.', 'restricción', 'Write the constraints before you sketch.'), (2, 'justify', 'verb', 'Say why your choice follows from the constraints.', 'justificar ≈', 'Justify the design you chose.'), (2, 'sketch', 'noun', 'A quick drawing of an idea.', 'boceto', 'Three sketches, one physics note each.'), (3, 'torque', 'noun', 'A turning push: force times distance from the center.', 'torque / par', 'A wide handle makes more torque on your hand.'), (3, 'center of mass', 'noun', 'The balance point of an object.', 'centro de masa ≈', 'Find the center of mass of the mug on the scale.')], 'pp-w07': [(1, 'strand', 'noun', 'One piece of pasta.', 'hebra / tira', 'Test one strand before you build.'), (1, 'load', 'noun', 'The weight a structure holds.', 'carga', 'Add load until the bridge breaks.'), (2, 'design', 'verb', 'Plan something to meet constraints.', 'diseñar ≈', 'Design the bridge to the span and the mass limit.'), (2, 'gap', 'noun', 'The difference between predicted and actual.', 'diferencia', 'Explain the gap between the two loads.'), (3, 'member', 'noun', 'One piece of a structure.', 'miembro ≈', 'Which member goes first?'), (3, 'failure load', 'noun', 'The load at which the structure breaks.', 'carga de fallo', 'Predict the failure load from your strand tests.'), (3, 'buckling', 'noun', 'A member in compression bending sideways and giving way.', 'pandeo', 'Long thin members fail by buckling.'), (3, 'joint', 'noun', 'Where members connect.', 'unión / nudo', 'Bridges often fail at a joint, not a member.')], 'pp-w08': [(1, 'same', 'adjective', 'Not different.', 'igual', 'Is this motion the same as the ramp?'), (1, 'new', 'adjective', 'Not seen before.', 'nuevo', 'A new structure, argued from the same physics.'), (2, 'transfer', 'verb', 'Use what you learned on something new.', 'transferir ≈', 'Transfer the truss idea to this roof.'), (2, 'rate', 'verb', 'Give yourself a 1, 2 or 3.', 'evaluarse', 'Rate yourself on every Phase 1 target.'), (2, 'artifact', 'noun', 'The page that proves what you learned.', 'artefacto ≈', 'Point to the artifact for each target.'), (3, 'status report', 'noun', 'A short account of what is known so far.', 'informe de estado', 'The analysts want a status report by December.')], 'pp-w09': [(1, 'drop', 'noun', 'The height the marble falls from.', 'caída', 'Find the minimum drop for the loop.'), (1, 'loop', 'noun', 'A full circle of track.', 'rizo / bucle', 'Will the marble make it round the loop?'), (2, 'minimum', 'noun', 'The smallest amount that still works.', 'mínimo ≈', 'The minimum drop is where the marble just makes it.'), (2, 'fraction', 'noun', 'A part of the whole, like 1/4 or 25%.', 'fracción ≈', 'Friction took what fraction of the energy?'), (3, 'energy', 'noun', 'The ability to make something move or change.', 'energía ≈', 'Energy moves from height to speed.'), (3, 'potential energy', 'noun', 'Stored energy from height.', 'energía potencial ≈', 'At the top the marble has potential energy.'), (3, 'kinetic energy', 'noun', 'Energy of motion.', 'energía cinética ≈', 'At the bottom it is kinetic energy.'), (3, 'conservation', 'noun', 'The total stays the same; energy only changes form.', 'conservación ≈', 'Conservation: what is lost from height shows up as speed or heat.')], 'pp-w10': [(1, 'wall', 'noun', 'A vertical structure of a building.', 'pared', 'Frame the wall from the plan.'), (1, 'sideways', 'adverb', 'To the side, not up or down.', 'de lado', 'Push the frame sideways.'), (2, 'plan', 'noun', 'A drawing that says how to build.', 'plano', 'Build from the framing plan.'), (2, 'follow', 'verb', 'Do what the plan or the direction says.', 'seguir', 'Follow one step at a time.'), (3, 'stud', 'noun', 'A vertical framing member.', 'montante', 'Studs are sixteen inches on center.'), (3, 'load path', 'noun', 'The route a load takes from the top to the ground.', 'ruta de la carga', 'Trace the load path from the plate to the floor.'), (3, 'shear', 'noun', 'Sideways force that makes a rectangle lean.', 'cortante / cizalla', 'Sheathing resists shear.'), (3, 'racking', 'noun', 'A frame leaning into a parallelogram under shear.', 'deformación lateral', 'The bare frame racks; the sheathed one does not.')], 'pp-w11': [(1, 'stretch', 'verb', 'Make longer by pulling.', 'estirar', 'Stretch the band and read the force.'), (1, 'spin', 'verb', 'Turn around fast.', 'girar', 'The propeller spins when the band lets go.'), (2, 'store', 'verb', 'Keep for later.', 'almacenar', 'The band stores energy.'), (2, 'efficiency', 'noun', 'Energy out divided by energy in.', 'eficiencia ≈', 'Report the efficiency as a percent.'), (3, 'elastic energy', 'noun', 'Energy stored in something stretched or twisted.', 'energía elástica ≈', 'Elastic energy is the area under the force–stretch curve.'), (3, 'work', 'noun', 'Force times distance; energy moved into or out of something.', 'trabajo (fuerza × distancia)', 'The band does work on the propeller.'), (3, 'power', 'noun', 'How fast energy is delivered: energy per second.', 'potencia (≠ poder)', "Power is the band's energy divided by the run time."), (3, 'drag', 'noun', 'Air friction on a moving object.', 'resistencia del aire', 'Drag is one of the losses.')], 'pp-w12': [(1, 'syringe', 'noun', 'A tube with a plunger.', 'jeringa', 'Push the small syringe.'), (1, 'lift', 'verb', 'Raise something up.', 'levantar', 'The claw lifts the mass.'), (2, 'multiply', 'verb', 'Make bigger by a factor.', 'multiplicar ≈', 'The big syringe multiplies the force.'), (2, 'ratio', 'noun', 'One number compared to another, like 4 to 1.', 'razón / proporción (≠ ratio)', 'Predict the force ratio from the diameters.'), (3, 'pressure', 'noun', 'Force spread over an area.', 'presión ≈', 'Pressure is the same everywhere in the tube.'), (3, 'area', 'noun', 'How much surface, in cm².', 'área ≈', 'A bigger area means more force at the same pressure.'), (3, 'hydraulic', 'adjective', 'Working by pushing a liquid.', 'hidráulico ≈', 'A hydraulic claw uses water in tubes.'), (3, "Pascal's principle", 'noun', 'Pressure in a trapped liquid is the same everywhere.', 'principio de Pascal ≈', "Pascal's principle is why small pushes big.")], 'pp-w13': [(1, 'loud', 'adjective', 'A big sound.', 'fuerte', 'A bigger cone is louder.'), (1, 'quiet', 'adjective', 'A small sound.', 'suave / bajo', 'A small cone is quiet.'), (2, 'chain', 'noun', 'A series of causes, one after another.', 'cadena', 'Write the chain from groove to ear.'), (2, 'trace', 'noun', 'The line the microphone draws.', 'registro / trazo', 'Sketch the trace and label it.'), (3, 'vibration', 'noun', 'A fast back-and-forth motion.', 'vibración ≈', "The needle's vibration moves the cone."), (3, 'amplitude', 'noun', 'How big the wave is; loudness.', 'amplitud ≈', 'A louder sound has a bigger amplitude.'), (3, 'frequency', 'noun', 'How many waves per second; pitch.', 'frecuencia ≈', 'A higher frequency sounds higher.'), (3, 'resonance', 'noun', 'When a shape makes one frequency much louder.', 'resonancia ≈', "The megaphone's resonance picks one note.")], 'pp-w14': [(1, 'battery', 'noun', 'A source of electric current.', 'batería / pila ≈', 'Touch the wire to the battery.'), (1, 'magnet', 'noun', 'An object with a magnetic field.', 'imán', 'Flip the magnet and predict again.'), (2, 'direction', 'noun', 'Which way: left, right, up, down.', 'dirección ≈', 'Predict the direction of rotation.'), (2, 'reverse', 'verb', 'Turn around to the opposite.', 'invertir', 'Reverse the battery; what happens?'), (3, 'current', 'noun', 'Moving electric charge in a wire.', 'corriente (≠ actual)', 'Current in the wire makes a magnetic field.'), (3, 'magnetic field', 'noun', 'The space around a magnet or current where a force acts.', 'campo magnético ≈', 'The compass shows the magnetic field.'), (3, 'motor', 'noun', 'A device that turns current into turning.', 'motor ≈', 'The simplest motor is a wire, a magnet and a battery.'), (3, 'rotation', 'noun', 'Turning around a center.', 'rotación ≈', 'Which way is the rotation?')], 'pp-w15': [(1, 'coil', 'noun', 'Wire wound in loops.', 'bobina', 'Wind the coil on the cup.'), (1, 'cup', 'noun', 'The paper cone that moves the air.', 'vaso', "The cup is the speaker's cone."), (2, 'signal', 'noun', 'A changing current that carries sound.', 'señal', 'The phone sends a signal to the coil.'), (2, 'cause', 'noun', 'What makes something happen.', 'causa ≈', 'Write the cause of each link.'), (3, 'electromagnet', 'noun', 'A coil that becomes a magnet when current flows.', 'electroimán', 'The coil is an electromagnet.'), (3, 'pressure wave', 'noun', 'Sound: a wave of pushed air.', 'onda de presión ≈', 'The cone makes a pressure wave.'), (3, 'speaker', 'noun', 'A device that turns a signal into sound.', 'altavoz / bocina', 'Our speaker is a coil, a magnet and a cup.'), (3, 'variable', 'noun', 'The one thing you change.', 'variable ≈', 'Change one variable: turns, magnet or cone.')], 'pp-w16': [(1, 'blade', 'noun', 'One arm of a turbine.', 'aspa', 'Change one blade and test.'), (1, 'fan', 'noun', 'The wind source.', 'ventilador', 'Point the fan at the turbine.'), (2, 'estimate', 'verb', 'Find an approximate number.', 'estimar ≈', 'Estimate the power going in.'), (2, 'output', 'noun', 'What comes out.', 'salida', 'Electrical output is V times I.'), (3, 'generator', 'noun', 'A device that turns spinning into current.', 'generador ≈', 'A generator is a motor run backwards.'), (3, 'induction', 'noun', 'A changing magnetic field making a current.', 'inducción ≈', 'Induction is why spinning the magnet makes current.'), (3, 'voltage', 'noun', 'The electric push, in volts.', 'voltaje ≈', 'Read the voltage while it spins.'), (3, 'turbine', 'noun', 'Blades that catch wind or water to spin a shaft.', 'turbina ≈', 'The turbine drives the generator.')], 'pp-w17': [(1, 'again', 'adverb', 'One more time.', 'otra vez', 'Build it again, better.'), (1, 'better', 'adjective', 'Improved.', 'mejor', 'Predict how much better.'), (2, 'redesign', 'verb', 'Change a design because of what you learned.', 'rediseñar ≈', 'Redesign one of your builds.'), (2, 'improve', 'verb', 'Make better.', 'mejorar', 'Which change will improve it most?'), (2, 'review', 'noun', 'A check of the work by others.', 'revisión ≈', 'The mission review board asks questions.'), (3, 'iteration', 'noun', 'One round of build, test, change.', 'iteración ≈', 'This is your second iteration.'), (3, 'test plan', 'noun', 'What you will measure and how.', 'plan de prueba', 'Write the test plan before the shop week.')], 'pp-w18': [(1, 'same conditions', 'noun', 'Everything the same as the first time.', 'las mismas condiciones', 'Test under the same conditions.'), (1, 'worked', 'verb', 'Did what you predicted.', 'funcionó', 'Say plainly whether it worked.'), (2, 'defend', 'verb', 'Explain and answer questions about your work.', 'defender ≈', 'Defend the redesign to the panel.'), (2, 'result', 'noun', 'What happened.', 'resultado ≈', 'State the prediction and the result.'), (2, 'panel', 'noun', 'The group that listens and asks.', 'panel ≈', 'The panel has your first artifact.'), (3, 'comparison', 'noun', 'Original and redesign, side by side.', 'comparación ≈', 'Show the comparison under the same conditions.'), (3, 'verdict', 'noun', 'The honest answer: did it work?', 'veredicto ≈', 'The verdict follows from the numbers.')], 'pp-w19': [(1, 'cover', 'noun', 'The first page.', 'portada', 'The timeline is the cover.'), (1, 'order', 'verb', 'Put in sequence.', 'ordenar', 'Order the artifacts by week.'), (2, 'portfolio', 'noun', 'All your artifacts, collected.', 'portafolio ≈', 'Assemble the portfolio.'), (2, 'growth', 'noun', 'Getting better over time.', 'crecimiento', 'Find the artifact where your growth shows.'), (2, 'reflect', 'verb', 'Look back and say what changed.', 'reflexionar ≈', 'Reflect on where your reasoning changed.'), (3, 'reasoning', 'noun', 'The thinking that connects evidence to a claim.', 'razonamiento', 'Point to where your reasoning got better.')]}
...
def lesson_blocks(w, idx):
    ...
    blocks.append({"id": "v1", "type": "lesson_vocab"})
...
out.append("\n-- Tiered SEI vocabulary: one set per week-lesson (keyed by lesson slug), terms replaced on re-run.")
for w in WEEKS:
    slug = w["slug"]
    out.append(f"insert into public.vocabulary_sets (name, description, unit_id, lesson_id, published, created_by) select {q('Week vocab · ' + w['en'])}, 'Tiered SEI vocabulary (Beck 1/2/3) with Spanish', {q(w['unit'])}, l.id::text, true, 'craigantocci@gmail.com' from public.lessons l where l.slug = {q(slug)} and not exists (select 1 from public.vocabulary_sets v where v.lesson_id = l.id::text);")
    out.append(f"delete from public.vocabulary_terms where vocabulary_set_id in (select v.id from public.vocabulary_sets v join public.lessons l on v.lesson_id = l.id::text where l.slug = {q(slug)});")
    rows = []
    for i, (tier, term, pos, dfn, es, ex) in enumerate(VOCAB[slug]):
        rows.append(f"({q(term)}, {q(dfn)}, {tier}, {q(es)}, {q(pos)}, {q(ex)}, {i})")
    out.append("insert into public.vocabulary_terms (vocabulary_set_id, term, definition, tier, cognate, part_of_speech, example, order_index) "
               f"select v.id, t.term, t.definition, t.tier, t.cognate, t.pos, t.example, t.ord from public.vocabulary_sets v join public.lessons l on v.lesson_id = l.id::text, (values " + ", ".join(rows) + f") as t(term, definition, tier, cognate, pos, example, ord) where l.slug = {q(slug)};")
