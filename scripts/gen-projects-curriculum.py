...
UNITS = [
    ("proj-1", 1, "Term 1: Motion, Forces & Structures", "Aug 31 – Dec 23 · nine academic weeks · from reading a graph to a bridge you designed yourself.", "2026-08-31"),
    ("proj-2", 2, "Term 2: Energy", "Jan 4 – Feb 12 · three academic weeks · where the energy goes.", "2027-01-04"),
    ("proj-3", 3, "Term 3: Fluids, Waves & Electromagnetism", "Mar 1 – Apr 16 · four academic weeks · pressure, sound, and the motor.", "2027-03-01"),
    ("proj-4", 4, "Term 4: Generation & the Capstone", "Apr 26 – Jun 10 · four academic weeks · the generator, then redesign one of your own builds and defend it.", "2027-04-26"),
]
...
WEEKS = [
 dict(slug="pp-w00", mon="2026-08-31", days=4, unit="proj-1", core=False, strand="engineering-design",
  en="Launch · Predict before you test", es="Lanzamiento · Predice antes de probar",
  targets=[
  ...
  opener="Something drops, rolls or flies in the first five minutes. Everyone writes a prediction on paper before anyone touches it. The prediction is graded for the reasoning, never for being right — say that out loud on day one.",
 ...
 dict(slug="pp-w01", mon="2026-09-14", days=5, unit="proj-1", core=True, strand="motion-graphs",
  en="Describing motion · Foundation week", es="Describir el movimiento · Semana de base",
  targets=[
  ...
  opener="Graph matching with the motion detector: the screen never draws a graph a student has not already sketched. Walk the graph; then the reverse — sketch the graph of a walk before it appears.",
 ...
 dict(slug="pp-w02", mon="2026-09-28", days=5, unit="proj-1", core=True, strand="motion-graphs",
  en="Car and ramp · Acceleration and its cause", es="Carro y rampa · La aceleración y su causa",
  targets=[
  ...
  opener="One cart, one ramp, three angles. Which angle gives the biggest acceleration, and by how much? Prediction locked before the first run.",
 ...
 dict(slug="pp-w03", mon="2026-10-12", days=4, unit="proj-1", core=True, strand="forces-dynamics",
  en="Balloon zip line · Newton's laws", es="Tirolesa de globo · Las leyes de Newton",
  targets=[
  ...
  opener="Send a Duplo passenger across the room on a string. Who gets farthest — and what stopped the rest?",
 ...
 dict(slug="pp-w04", mon="2026-10-26", days=5, unit="proj-1", core=True, strand="forces-dynamics",
  en="Water rockets · Impulse, momentum, projectiles", es="Cohetes de agua · Impulso, cantidad de movimiento, proyectiles",
  targets=[
  ...
  opener="Outdoors, last dependable week for it. Two liters, a launcher, a stopwatch. How high, and what decides it?",
 ...
 dict(slug="pp-w05", mon="2026-11-09", days=4, unit="proj-1", core=True, strand="structures",
  en="Card-stock bridges from a template · Equilibrium", es="Puentes de cartulina con plantilla · Equilibrio",
  targets=[
  ...
  opener="Templated on purpose — a four-day week and a first structure should not also be an open design. Cut, fold, glue; then decide which member goes first.",
 ...
 dict(slug="pp-w06", mon="2026-11-23", days=3, unit="proj-1", core=False, strand="engineering-design",
  en="Coffee mug redesign · The design process", es="Rediseño de una taza · El proceso de diseño",
  targets=[
  ...
  opener="Three days before Thanksgiving is the wrong time for a load test and the right time for a design sprint. Interview a user, write constraints, sketch three, choose one.",
 ...
 dict(slug="pp-w07", mon="2026-12-07", days=5, unit="proj-1", core=True, strand="structures",
  en="Pasta bridges · Open structural design", es="Puentes de pasta · Diseño estructural abierto",
  targets=[
  ...
  opener="The template is gone. Span, mass limit, load target. Before you build, test one strand — how much does one piece of pasta actually hold?",
 ...
 dict(slug="pp-w08", mon="2026-12-21", days=3, unit="proj-1", core=False, strand="transfer",
  en="Term 1 checkpoint · Re-activation", es="Punto de control del trimestre 1 · Reactivación",
  targets=[
  ...
  opener="Not a new build. A transfer task on something they have not seen, a self-rating against every Term 1 target, and the first real read of the engineering timeline.",
 ...
 dict(slug="pp-w09", mon="2027-01-04", days=5, unit="proj-2", core=True, strand="energy-transfer",
  en="Marble roller coasters · Energy conservation", es="Montañas rusas de canica · Conservación de la energía",
  targets=[
  ...
  opener="Card-stock track from templates. Before the loop goes in: how high does the start have to be for the marble to make it round? Locked, then built.",
 ...
 dict(slug="pp-w10", mon="2027-01-18", days=3, unit="proj-2", core=False, strand="structures",
  en="Balsa stick-framed wall · Structures from a plan", es="Pared de bastidor de balsa · Estructuras a partir de un plano",
  targets=[
  ...
  opener="Three days, a templated build, and the direct link to the trades section. Frame it; then push it sideways before and after sheathing.",
 ...
 dict(slug="pp-w11", mon="2027-02-01", days=5, unit="proj-2", core=True, strand="energy-transfer",
  en="Lou-Vee air cars · Work, power, efficiency", es="Carros de aire Lou-Vee · Trabajo, potencia, eficiencia",
  targets=[
  ...
  opener="Rubber-band propeller cars. The band stores energy; the car gets some of it. How much, and where did the rest go?",
 ...
 dict(slug="pp-w12", mon="2027-03-01", days=5, unit="proj-3", core=True, strand="fluids-pressure",
  en="Hydraulic claws · Pressure and Pascal", es="Garras hidráulicas · Presión y Pascal",
  targets=[
  ...
  opener="Syringes and tubing. Push the small one; the big one moves — with more force and less distance. Predict the ratio from the diameters before you measure it.",
 ...
 dict(slug="pp-w13", mon="2027-03-15", days=5, unit="proj-3", core=True, strand="waves-sound",
  en="Record player and megaphone · Sound as a wave", es="Tocadiscos y megáfono · El sonido como onda",
  targets=[
  ...
  opener="A paper cone, a pin, a record spun by hand. Music comes out. Then a megaphone. What is the cone doing to the groove's motion, and to the air?",
 ...
 dict(slug="pp-w14", mon="2027-03-29", days=5, unit="proj-3", core=True, strand="electromagnetism",
  en="World's simplest motor · Current, field, force", es="El motor más simple del mundo · Corriente, campo, fuerza",
  targets=[
  ...
  opener="Battery, magnet, a bent wire. It spins. Before the first spin: which way? Then flip the magnet — which way now?",
 ...
 dict(slug="pp-w15", mon="2027-04-12", days=5, unit="proj-3", core=True, strand="electromagnetism",
  en="Build a speaker · Electromagnetism drives sound", es="Construye un altavoz · El electromagnetismo produce sonido",
  targets=[
  ...
  opener="Coil, magnet, cup. Plug it into a phone. Sound. This is the motor and the record player in one object — say how.",
 ...
 dict(slug="pp-w16", mon="2027-04-26", days=5, unit="proj-4", core=True, strand="electromagnetism",
  en="Wind and water turbines · Induction and power", es="Turbinas de viento y agua · Inducción y potencia",
  targets=[
  ...
  opener="A DC motor with blades on it, a fan or a tap. The motor becomes a generator. How much comes out, compared with what went in?",
 ...
 dict(slug="pp-w17", mon="2027-05-10", days=5, unit="proj-4", core=True, strand="engineering-design",
  en="Capstone I · Redesign one of your own builds", es="Proyecto final I · Rediseña una de tus construcciones",
  targets=[
  ...
  opener="Two-week arc, with a shop week in the middle. This week: choose, plan, predict, build. The shop week carries only a question. Next academic week: test and defend.",
 ...
 dict(slug="pp-w18", mon="2027-05-24", days=5, unit="proj-4", core=True, strand="engineering-design",
  en="Capstone II · Test and defend", es="Proyecto final II · Prueba y defiende",
  targets=[
  ...
  opener="Same conditions as the original. Test. Then stand up and defend it — in either language — to a panel that has your first-round artifact in front of them.",
 ...
 dict(slug="pp-w19", mon="2027-06-07", days=4, unit="proj-4", core=False, strand="metacognition",
  en="Portfolio and final self-assessment", es="Portafolio y autoevaluación final",
  targets=[
  ...
  opener="Every artifact of the year, the timeline as the cover page. Re-rate. Find the one where it changed.",
...
--   3. learning_targets.statement_es — Spanish statement for bilingual targets
...
out.append("insert into public.learning_targets (slug, statement, statement_es, domain, unit_id, content_strand, standard_refs, exclude_from_growth, order_index, program) values")
vals = []
n = 0
for w in WEEKS:
    for slug, en, es, dom in w["targets"]:
        n += 1
        vals.append(f"  ({q(slug)}, {q(en)}, {q(es)}, {q(dom)}, {q(w['unit'])}, {q(w['strand'])}, {arr(STANDARDS[w['strand']])}, false, {n}, 'projects')")
out.append(",\n".join(vals))
out.append("on conflict (slug) do update set statement = excluded.statement, statement_es = excluded.statement_es, domain = excluded.domain, unit_id = excluded.unit_id, content_strand = excluded.content_strand, standard_refs = excluded.standard_refs, order_index = excluded.order_index, program = excluded.program;\n")
